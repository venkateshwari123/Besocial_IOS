...
public struct TLPhotosPickerConfigure {
    public var customLoclizedTitle: [String: String] = ["Camera Roll".localized: "Camera Roll".localized]
    public var tapHereToChange = "Tap here to change".localized
    public var cancelTitle = "Cancel".localized
    public var doneTitle = "Done".localized
    public var emptyMessage = "No albums".localized
...
extension String{
    ...
    var localized: String {
        return self.localised(forLanguage: getSelectedLanguegeCode() == "ja" ? ("ja") : ("en"))
    }
    ...
    func getSelectedLanguegeCode() -> String{
        guard let lang = UserDefaults.standard.value(forKey: "currentLang") as? String else{return ""}
        return lang
    }
}
