...
public enum KeychainSwiftAccessOptions {
  ...
  */
  ...
  func toString(_ value: CFString) -> String {
    ...
    /// this array of disctionary collecion used to store actually data for params , also holds the textFiled Placeholder for diplaying in textField , if you want add a textField on view just add the placeholder for that textField in "placeHolderArray" collection , if the textField text send for API just add the parameters name as the value of that key other wise leave it blank
    
    /// for example :   [ StringConstants.signUP_CPassword() : "" ]
