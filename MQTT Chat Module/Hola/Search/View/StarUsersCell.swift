...
//  PicoAdda
//
//  Created by 3Embed on 24/10/19.
//  Copyright © 2019 Rahul Sharma. All rights reserved.
//

import UIKit

protocol StarUsersCellDelegate: class{
    func followingButtonAction(cell: StarUsersCell)
}

class StarUsersCell: UITableViewCell {
    ...
    weak var delegate: StarUsersCellDelegate?
