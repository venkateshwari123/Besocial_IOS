...
class RepliedStickerSentCollectionViewCell : JSQMessagesCollectionViewCell {
...
extension RepliedStickerSentCollectionViewCell : JSQMessagesCollectionViewCellDelegate {
...
class RepliedStickerSentMediaItem : NSObject, JSQMessageMediaData {
    
    /// Used for the instance of SentLocationCell
    let imageCell = RepliedStickerSentCollectionViewCell(frame:CGRect(x: 0, y: 0, width: 240, height: 260))
