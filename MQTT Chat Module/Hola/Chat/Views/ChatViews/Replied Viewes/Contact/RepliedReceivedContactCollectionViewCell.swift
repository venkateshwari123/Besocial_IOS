...
class RepliedReceivedContactCollectionViewCell : JSQMessagesCollectionViewCell {
...
extension RepliedReceivedContactCollectionViewCell : JSQMessagesCollectionViewCellDelegate {
...
/// RepliedReceivedContactMediaItem inherites the JSQMessageMediaData properties
class RepliedReceivedContactMediaItem : NSObject, JSQMessageMediaData {
    
    /// Used for the instance of ReceivedLocationCell
    let contactCell = RepliedReceivedContactCollectionViewCell(frame:CGRect(x: 0, y: 0, width: 310, height: 146))
    ...
    func mediaViewDisplaySize() -> CGSize {
        return CGSize(width: 310, height: 146)
    }
