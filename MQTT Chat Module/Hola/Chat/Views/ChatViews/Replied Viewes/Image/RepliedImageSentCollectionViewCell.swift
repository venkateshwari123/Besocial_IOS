...
class RepliedImageSentCollectionViewCell: JSQMessagesCollectionViewCell {
...
extension RepliedImageSentCollectionViewCell : JSQMessagesCollectionViewCellDelegate {
...
class RepliedSentImageMediaItem : NSObject, JSQMessageMediaData {
    
    /// Used for the instance of SentLocationCell
    let imageCell = RepliedImageSentCollectionViewCell(frame:CGRect(x: 0, y: 0, width: 240, height: 260))
