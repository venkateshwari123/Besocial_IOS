...
class SKRecordView: UIView, AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    var normalImage = UIImage(named: "voiceRecorderImg")!
   var recordingImages = [UIImage(named: "rec1")!,UIImage(named: "rec2")!,UIImage(named: "rec3")!,UIImage(named: "rec4")!,UIImage(named: "rec5")!,UIImage(named: "rec6")!]
    ...
    func setupLabel() {
        ...
        let vConsts = NSLayoutConstraint(item: slideToCancel, attribute: .bottom, relatedBy: .equal, toItem: recordButton, attribute: .bottom, multiplier: 1.0, constant: -8)
        let hConsts = NSLayoutConstraint(item: slideToCancel, attribute: .trailing, relatedBy: .equal, toItem: recordButton, attribute: .leading, multiplier: 1.0, constant: -20 ) //-5
        ...
        slideToCancel.font = UIFont.systemFont(ofSize: 15)
        slideToCancel.textAlignment = .center
    ...
    override var intrinsicContentSize : CGSize {
        ...
        if state == .none {
            ...
            return CGSize(width: recordButton.intrinsicContentSize.width * 12, height: recordButton.intrinsicContentSize.height)
        }
    }
    ...
    @objc func userDidTapRecord(_ gesture: UIGestureRecognizer) {
        ...
        case .failed, .possible ,.cancelled : if state == .recording {
            userDidStopRecording(button)
