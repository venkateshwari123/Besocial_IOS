...
=======
>>>>>>> 5197f4e417f9c17993c86826c89267ceceb517ba
...
<<<<<<< HEAD
        ...
        if let postsCount = noofPostsCount {
            ...
            header.hashTagViewsCount.text = "\(postsCount) Posts"
            }else{
                header.hashTagViewsCount.text = "\(postsCount) Post"
=======
        /*
         Bug Name:- Post count is incorrect in hashtag page
         Fix Date:- 17/06/21
         Fix By  :- Jayaram G
         Description of Fix:- Showing postcount from explore page
         */
            if noofPostsCount > 1 {
                header.hashTagViewsCount.text = "\(noofPostsCount) Posts"
            }else{
                header.hashTagViewsCount.text = "\(noofPostsCount) Post"
>>>>>>> 5197f4e417f9c17993c86826c89267ceceb517ba
            }
        return header
    }
