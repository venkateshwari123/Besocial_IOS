...
extension UIColor {
    ...
    /// Easily define two colors for both light and dark mode.
        ...
        static func setColor(lightMode: String, darkMode: String) -> UIColor {
            let light = Helper.hexStringToUIColor(hex: lightMode)
            let dark = Helper.hexStringToUIColor(hex: darkMode)
