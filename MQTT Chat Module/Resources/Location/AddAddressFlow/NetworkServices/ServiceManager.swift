...
class ServiceManager: NSObject {
    ...
    static let PlacesAPILink                            = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=%@&location=%f,%f&radius=100000&amplanguage=%@&key=AIzaSyA2oyiPnTPYwFvqk_EWw9RbE0-V3IeGHfA"
    static let PlaceEnlarge                             = "https://maps.googleapis.com/maps/api/place/details/json?placeid=%@&key=AIzaSyA2oyiPnTPYwFvqk_EWw9RbE0-V3IeGHfA"
