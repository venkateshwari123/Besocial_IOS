...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    @IBInspectable open var URLColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0.9568627451, alpha: 1) {
        didSet { updateTextStorage(parseText: false) }
    }
    ...
    fileprivate var defaultCustomColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0.9568627451, alpha: 1)
    ...
    fileprivate func updateAttributesWhenSelected(_ isSelected: Bool) {
        ...
        if isSelected {
            ...
            case .custom:
                ...
                /*
                 Refactor Name:- change url color to blue
                 Refactor Date:- 30/04/21
                 Refactor By  :- Nikunj C
                 Description of Refactor:- change default color to URLColor
                 */
            ...
            /*
             ...
             Refactor Date:- 30/04/21
             Refactor By  :- Nikunj C
             Description of Refactor:- change url color to URLColor
             */
