...
open class Floaty: UIView {
   ...
   */
  @IBInspectable
  @objc open var buttonColor: UIColor = UIColor(red: 212/255.0, green: 170/255.0, blue: 93/255.0, alpha: 1)
...
//    NotificationCenter.default.addObserver(self, selector: #selector(deviceOrientationDidChange(_:)), name: UIDevice.NSNotification.Name.UIDeviceOrientationDidChange, object: nil)
...
//    guard let keyboardSize: CGFloat = (notification.userInfo?[UIResponder.UIKeyboardFrameEndUserInfoKey] as? NSValue)?.cgRectValue.size.height,
