...
extension PhotoEditorViewController {
    ...
    @objc internal func KeyboardDidShowPhotoEditor(_ notification: NSNotification) {
        if isTyping {
    ...
    @objc internal func keyboardWillHidePhotoEditor(_ notification: NSNotification) {
        isTyping = false
