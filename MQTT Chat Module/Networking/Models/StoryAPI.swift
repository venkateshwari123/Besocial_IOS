...
class StoryAPI: NSObject {
    ...
    func getAllStories(withURL strURL: String, complitation: @escaping(_ socialModel: Any?, _ error : CustomErrorStruct?)-> Void){
        ...
        apiCall.newtworkRequestAPIcall(serviceName: strURL, requestType: .get, parameters: params ,headerParams:headers, responseType: AppConstants.resposeType.getTrendingResponse.rawValue)
    ...
    func postNewStory(with strURL: String, params:[String:Any], complitation: @escaping(_ socialModel: Any?, _ error : CustomErrorStruct?)-> Void){
        ...
        let apiCall = RxAlmofireClass()
        apiCall.newtworkRequestAPIcall(serviceName: strURL, requestType: .post, parameters: params, headerParams: headers, responseType: AppConstants.resposeType.postTrendingResponse.rawValue)
