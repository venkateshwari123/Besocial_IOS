...
class DocumentListAPI {
    ...
    func getDocumentList(withURL strURL: String,params: [String:Any]?, complitation: @escaping(_ socialModel: Any?, _ error : CustomErrorStruct?)-> Void){
